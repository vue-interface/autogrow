...
function index_escape(html) {
  var el = document.createElement('textarea');
  el.textContent = html;
  return el.innerHTML;
}

function index_unescape(html) {
  var el = document.createElement('textarea');
  el.innerHTML = html;
...
function input(div, el, minHeight, maxHeight) {
  div.innerHTML = index_escape(el.value).replace(/(?:\r\n|\r|\n)/g, '<br />') + '&nbsp;';
...
/* harmony default export */ var lib_vue_loader_options_mainvue_type_script_lang_js_ = (index);
...
/******/ })["default"];
//# sourceMappingURL=Autogrow.common.js.map